...
try {
    if (!in_array($_SESSION['role'], ['admin', 'superadmin'])) {
        exit('<tr><td colspan="13">No autorizado. Accesible solo para administradores.</td></tr>');
    }

    // El administrador ve solo SUS propios votantes que ha creado
...
<tr>
    <td style="text-align: center;">
        <input type="checkbox" class="row-checkbox" value="<?php echo $registro['id']; ?>">
    </td>
    <td>
    ...
    <td>
        ...
        <?php if ($yaVoto == 1): ?>
        <a href="toggle_voto.php?id=<?php echo $registro['id']; ?>&field=yavoto&v=tus_votantes.php" class="btn btn-sm"
        ...
        <!-- Toggle Estado Voto -->
        <a href="toggle_voto.php?id=<?php echo $registro['id']; ?>&field=estado&v=tus_votantes.php" class="btn btn-sm"
        ...
        <a href="eliminar_registro.php?id=<?php echo $registro['id']; ?>&return=tus" class="btn btn-delete btn-sm"
